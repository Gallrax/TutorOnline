...
<div class="pc_main_box">
    <div class="gbox">
        <p class="sty1"><a id="t" href="#">教师列表</a></p>
        <ul id="subs">
...
<script>
    ...
    function getTeachers(index) {
        $.ajax({
            url: "${pageContext.request.contextPath}/user/getTeachers",
            type: "get",
            data: "index="+ index,
            success: function (data) {
                ...
                for (var i = 0; i < obj.length; i++) {
                   str += "<li><a class=\"flimg\" href=\"javascript:void(0)\"><img src=\"${pageContext.request.contextPath}/images/test_subject.jpg\"></a><div class=\"rbox\"><p class=\"title\"><a href=\"${pageContext.request.contextPath}/teacherInfo.jsp?id="+ obj[i].id +"\">" + obj[i].name + "</a></p><div class=\"des\"><p>" + obj[i].description + "</p></div></li>";
                }
                $("#subs").html(str);
            }
        });
    ...
    function getPage(field, value) {
        $.ajax({
            url: "${pageContext.request.contextPath}/user/getPage",
            type: "get",
            data: "field="+ field +"&value="+ value,
            success: function (data) {
                var str = "";
                for (var i = 1; i <= data; i++) {
                    str += "<a href=\"#\" onclick=\"getTeachers("+ i +")\">"+ i +"</a>&nbsp";
                }
                $("#page").html(str);
            }
        });
