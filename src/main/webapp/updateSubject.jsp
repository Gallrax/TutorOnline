...
<div class="pc_main_box mainbox">
    ...
    <div class="user_content_box" style="width: 75%;float: right;display: block">
        ...
        <div class="n-main-container">
            <form class="info_reg" id="info_reg" action="${pageContext.request.contextPath}/subject/updateSubject" method="post" >
                <input id="n-id" class="ipt" name="id" type="hidden">
                <p>
                ...
                <button id="xg-btn" type="submit">确认更改</button>
            </form>
    ...
    function getSubject(id) {
        $.ajax({
            ...
            success : function (data) {
                ...
                $("#n-id").val(obj.id);
                $("#n-title").val(obj.title);
                $("#n-description").val(obj.description);
                $("#n-address").val(obj.address);
                $("#n-money").val(obj.money);
                $("#n-beginTime").val(obj.beginTime);
                $("#n-endTime").val(obj.endTime);
            }
        });
    }
