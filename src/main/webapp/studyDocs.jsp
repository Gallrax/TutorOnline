        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < obj.length; i++) {
                   str += "<li><a class=\"flimg\" href=\"javascript:void(0)\"><img src=\"${pageContext.request.contextPath}/images/test_subject.jpg\"></a><div class=\"rbox\"><p class=\"title\"><a href=\"${pageContext.request.contextPath}/studyDocInfo.jsp?id="+ obj[i].id +"\">" + obj[i].title + "</a></p></li>";
                }
                $("#subs").html(str);
            }
        });
